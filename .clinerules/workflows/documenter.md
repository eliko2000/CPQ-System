# Documenter Workflow - CPQ System

**Purpose**: Update CLAUDE.md, write JSDoc for complex CPQ functions, create technical documentation, and maintain project knowledge base.
...
- Multiple valid documentation approaches
- Unclear audience for documentation
- Balancing detail vs readability

## Success Metrics

- Documentation matches current implementation
- New developers can understand business logic without assistance
- Examples work and demonstrate real usage
- Cross-references are accurate and helpful
- Documentation covers all critical business rules

## Key Principle

Documentation should enable any developer to understand the business logic and make changes without breaking critical pricing calculations.
