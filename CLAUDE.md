...
2. [TypeScript Best Practices](#typescript-best-practices) ⭐ **REQUIRED READING**
3. [Architecture](#architecture)
4. [File Import System](#file-import-system)
5. [Parser Services](#parser-services)
...
⚠️ **CRITICAL**: Follow these rules to prevent TypeScript build errors and maintain code quality.
...
4. **Saves Time**: Prevents "fix TypeScript errors" sessions like the one that created these rules

### Detailed Guide

For comprehensive TypeScript guidelines, see: **[docs/TYPESCRIPT_BEST_PRACTICES.md](docs/TYPESCRIPT_BEST_PRACTICES.md)**
