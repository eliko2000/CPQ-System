...
When creating or updating documentation, follow these naming conventions:
...
- **Reports**: `REPORT_`, `BUGFIX_` (e.g., `REPORT_TEST_SUMMARY.md`)
...
_This CPQ system is now optimized for Cline's natural language approach while maintaining all the sophisticated business logic and quality standards from the original Claude Code setup._
