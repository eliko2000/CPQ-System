...
function normalizeCategory(category: string | null | undefined): string {
  ...
  if (lower.includes('actuator') || lower.includes('valve'))
    return 'אקטואטורים';
  // ... more mappings
 ...
 */
export async function parseNewFormatFile(
  file: File
...
- Add to `../../CLAUDE.md`
- Add to `../user-guides/GUIDE_FILE_IMPORT.md`
- Add examples
...
```typescript
const pagePromises = pdfData.pages.map(page => processPageAsync(page.text));
