...
1. **../developer/IMPL_FILTERS.md**
   - Complete implementation guide
   - Filter type differences
   - Common pitfalls
   - Debugging instructions

2. **../planning/PLAN_FILTER_TESTS.md**
...
- `../developer/IMPL_FILTERS.md` - Implementation guide
- `../planning/PLAN_FILTER_TESTS.md` - Testing requirements
- `REPORT_FILTER_BUGS.md` - This document
...
- Review `../developer/IMPL_FILTERS.md` for implementation details
- Check `../planning/PLAN_FILTER_TESTS.md` before modifying filters
